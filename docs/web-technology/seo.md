...
以下是 Github 的 [TDK 查询](https://seo.chinaz.com)信息，可以注意到一些字符长度限制。

![TDZ](/img/TDK.png)

::: warning 注意
title: 标题**不宜过长**，冗长的标题可能导致关键词密度降低，从而影响搜索引擎对网页内容的判断

description: 内容**不宜过短**，作为摘要信息展示的时候如果一行都显示不全，不利于吸引用户点击

keywords: 不同页面的关键词应该**尽量不重复**，避免关键词相互竞争, 关键词的数量应控制在 4-8 个，过多可能会被搜索引擎认为是关键词堆砌，影响 SEO 效果
:::
